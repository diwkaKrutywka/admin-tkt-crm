    ...
    >
      <a-form layout="vertical" :model="form" :rules="rules" ref="formRef">
        ...
        <a-form-item :label="$t('l_Street_type')" name="street_type">
          <a-input v-model:value="form.street_type" />
        </a-form-item>
        ...
        <a-form-item :label="$t('l_OSM_ID')" name="osm_id">
          <a-input v-model:value="form.osm_id" />
        </a-form-item>
  
        <a-form-item :label="$t('l_Geometry')" name="geometry">
          <a-input v-model:value="form.geometry" />
        </a-form-item>
  
        <a-form-item :label="$t('l_Custom')" name="is_custom">
          <a-switch v-model:checked="form.is_custom" />
        </a-form-item>
      </a-form>
    </a-modal>
  </template>
